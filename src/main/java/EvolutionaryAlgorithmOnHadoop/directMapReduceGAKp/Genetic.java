package EvolutionaryAlgorithmOnHadoop.directMapReduceGAKp;
...
public class Genetic {
 ...
 public static void main(String[] args) throws Exception {
    ...
    FileInputFormat.addInputPath(job, new Path("knap_input_validation1.in"));
    FileOutputFormat.setOutputPath(job, new Path("kp_report"));
