package EvolutionaryAlgorithmOnHadoop.onemax.elephant56.examples.onemax;

import EvolutionaryAlgorithmOnHadoop.onemax.elephant56.user.common.BitStringIndividual;
import EvolutionaryAlgorithmOnHadoop.onemax.elephant56.user.operators.BitStringMutation;
import EvolutionaryAlgorithmOnHadoop.onemax.elephant56.user.operators.BitStringSinglePointCrossover;
import EvolutionaryAlgorithmOnHadoop.onemax.elephant56.user.operators.OneMaxFitnessEvaluation;
import EvolutionaryAlgorithmOnHadoop.onemax.elephant56.user.operators.RandomBitStringInitialisation;
...
public class SequentialApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<IndividualWrapper<Individual, FitnessValue>> outputPopulation = driver.getOutputPopulation();

        for (IndividualWrapper<Individual, FitnessValue> population : outputPopulation)
            System.out.println(population.getIndividual().toString() + "|" + population.getFitnessValue());
    }
}
